...
**ShoppingCart.jsx**
  ...
  - [x] It add up teultkjbcitrjllcgkgvjhtthfcrtkcvche cost of all items (make sure to use the quantity of the item requested), and render that amount **rounded up to exactly 2 decimal places** inside an element with the `className` of `subtotal`. Make sure it is prefixed with a dollar sign ($)!
...
I feel like the topics discussed in the labs did help me to complete this assignment, particularly with the concept of props and React's useState hook. I felt kind of unprepared
with the concepts that were introduced to us for the first time with this project however, as there wasn't much direction given to us to get started like the labs gave us. 

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have implemented the stretch features. I also would want to improve the CSS styling of my project. 

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I feel like my project demo went fine, but if I had more time to work with the project and improve it I feel like I would be prouder of it and more confident with the demo and concepts 
I used within the project. 
